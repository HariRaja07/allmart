...
const DealsPage = ({ cartItems, setCartItems }) => {
  ...
  return (
    <div className="flex flex-col container mx-auto mt-40 min-h-screen bg-[#d4eafa] rounded-lg mb-12">
      <h2 className="inline-block text-3xl font-bold text-[#ffd124] border-2 border-[#ffd124] bg-[#0f5286] p-2 font-[roboto] mb-6 rounded-full text-center">
        Top Deals
      </h2>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex justify-center items-center space-x-2">
                    <p className="text-lg text-[#0f5286] font-semibold">
