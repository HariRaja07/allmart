...
const DealsPage = ({ cartItems, setCartItems }) => {
  ...
  useEffect(() => {
    const fetchDeals = async () => {
      try {
        ...
        setActiveDeals(response.data.data.activeDeals);  // Set the product list based on category
  ...
  const addToCart = (item) => {
    const discountedPrice = item.product?.sellingprice - (item.product?.sellingprice * (item.discountPercentage / 100));
  ...
  return (
    <div className='flex flex-col container mx-auto mt-40 min-h-screen bg-[#d4eafa] rounded-lg mb-12'>
      <h2 className="inline-block text-3xl font-bold text-[#ffd124] border-2 border-[#ffd124] bg-[#0f5286] p-2 font-[roboto] mb-6 rounded-full text-center">Top Deals</h2>
            ...
            activeDeals.map(item => {
              ...
              return (
                ...
                onClick={(e) => {
                  ...
                  <p className='absolute text-white font-semibold p-1 bg-[#e81e25] rounded'>{item.discountPercentage}% OFF</p>
          ...
          <div className="flex flex-col space-y-2 bg-white p-4 rounded-lg max-w-6xl w-full">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col justify-start space-y-2">
                ...
                <p className="text-xl text-[#e81e25] font-bold">Deal of the Store: <span className='bg-[#e81e25] text-white px-2 rounded-lg'>{selectedProduct.discountPercentage}% OFF</span></p>
                </div>
                
                {selectedProduct.product.sellingprice && selectedProduct.discountPercentage !== undefined ? (
                  (() => {
                    const discountedPrice = selectedProduct.product.sellingprice - (selectedProduct.product.sellingprice * (selectedProduct.discountPercentage / 100));
                    ...
                    return (
                      <div className="flex flex-col">
                        ...
                        <p className="text-xl text-[#e81e25]">-{selectedProduct.discountPercentage}%</p>
